# Website
[Battles 2 Popology Website](https://b2popology.com)
# Issues
To report issues with the data or website submit them at the [issues tab](https://github.com/emilplane/b2popology/issues) or through the [Discord server](https://discord.gg/6S2k7VWVnE).
# Contibution
You can also speed up changes by submitting your own pull requests.

**Prerequisites:**
* Github account.

* (OPTIONAL) git or some graphical git/github management tool.
...
7. Wait until request is accepted.
